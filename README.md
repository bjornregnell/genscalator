...
* smarter?  TODO try stay rot free
* safer? TODO try to avoid conf fatigue
* faster?  TODO try to make joint communiaction and workflow effient AND tool runs fast esp if complied to native binaries
