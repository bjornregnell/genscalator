...
* The above image shows the genscalator status lines. The first line is the *introspection line* with important data and metrics. The secont line is the *mode line* with current joint human-agent modes. 
