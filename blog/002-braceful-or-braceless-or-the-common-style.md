...
> **Status: drafted 2026-07-03; published 2026-07-08.** **Author: Björn Regnell.** A Scala-syntax post that judges braces vs
...
(frozen design in [`BIG-RUN-PREREG.md`](../research/experiments/indent-vs-braces/BIG-RUN-PREREG.md); write-up in the
