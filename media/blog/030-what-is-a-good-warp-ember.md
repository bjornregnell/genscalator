...
<!-- Slug/number 030. Agent scaffold in BR's voice per the blog-assist skill; BR has NOT revoiced yet.
     Sources: the joint design pass 2026-07-19, docs/EMBER-EXAMPLE.md, the P3b fidelity self-tests,
...
We published this one verbatim in [EMBER-EXAMPLE.md](../../docs/EMBER-EXAMPLE.md), because it worked:
...
result: [EMBER-TEMPLATE.md](../../docs/EMBER-TEMPLATE.md), living in the repo next to the real specimen.
...
- [EMBER-EXAMPLE.md](../../docs/EMBER-EXAMPLE.md) - the real, working warp-ember specimen, verbatim,
