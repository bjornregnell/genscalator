...
//   scala-cli run media/graphical-profile/DesignLang.scala
...
object DesignLang {
  ...
  def readme: String =
    s"""$generatedNote
       ...
       |here, please: edit the Scala file and re-run it (`scala-cli run media/graphical-profile/DesignLang.scala`).*
       |
...
${f"${ratio(ash.hex, ctip.hex)}%.2f"} on bone-white. Role: garments, silhouette mid-tones, muted furniture on dark grounds.
  ...
  // (a security doc, a graphical-profile page, a future doc) reads exactly like a blog post.
  ...
  def designCss: String =
    s"""/* GENERATED by DesignLang.scala - DO NOT EDIT. Edit DesignLang.scala and re-run:
       |   scala-cli run media/graphical-profile/DesignLang.scala --main-class generateDesignLanguage
  ...
  def blogTemplate: String =
    s"""<!doctype html>
       ...
       |   Palette: media/graphical-profile (GENERATED, do not edit here). The tok- vars live here
