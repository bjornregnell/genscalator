...
- **Round 12** (2026-07-07) — Updated blog 012 stub (`blog/012-will-i-lose-you.md`) with the coding-friend section — the completed study's new, strongest, dev-facing punchline (the redundant-style null, the decoy-degrades-what-it-lies-about, and the gut-punch "more notes made weak models WORSE"). **Additive**: preserved all of BR's existing hook, reframe, echt-caveat, model-switch, open-questions, and phrasebook (BR's imagery) untouched; added beats + draft framing marked "for BR to voice," no em-dash. The blog is a BR-authored publication BR voices; this hands him the material. Commit: this.
