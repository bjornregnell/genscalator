...
### Scala style
- [`017-scala-style-recommendations.md`](topics/RT017-scala-style-recommendations.md) — the **common-style note** itself
...
- [`001-scala-style-evolution.md`](topics/RT001-scala-style-evolution.md) — how should the `scala-style` skill self-consciously
  evolve, guided by agents using it, without drifting or bloating?

### Context fill, smart zone, token budget
- [`006-smart-zone-ceiling.md`](topics/RT006-smart-zone-ceiling.md) — can we *estimate* **Z**, the context-fill fraction at which
  the agent crosses smart→dumb zone, so an instrument can brake before degradation rather than at the hard limit?
- [`007-token-budget-awareness.md`](topics/RT007-token-budget-awareness.md) — how can an agent become aware of its token-spending
  *rate* across nested limits and *pace* itself, so brittle spend never causes a hard halt mid-task?
- [`039-can-we-give-agent-introspection-wall-clock.md`](topics/RT039-can-we-give-agent-introspection-wall-clock.md) — *(stub)*
...
- [`041-token-speed-degradation-with-context-fill.md`](topics/RT041-token-speed-degradation-with-context-fill.md) — *(stub)*
...
- [`022-proactive-compaction-point.md`](topics/RT022-proactive-compaction-point.md) — should we compact *proactively* (before the
...
- [`002-communication-bandwidth.md`](topics/RT002-communication-bandwidth.md) — for a non-native-English human + an English-centric
  agent, what's the bandwidth- and TE-optimal language *per direction*? (Human L1 in, agent cheapest-clear out.)
- [`027-steering-doc-design-tension.md`](topics/RT027-steering-doc-design-tension.md) — the tension between **terse hard DO/DON'Ts**
...
- [`004-instructions-for-claude.md`](topics/RT004-instructions-for-claude.md) — highest-leverage content for the agent's *global*
  custom-instructions field vs what belongs in AGENTS.md/skill/memory. Includes BR's current instructions as a
  worked example.
- [`003-instruction-surfaces-precedence.md`](topics/RT003-instruction-surfaces-precedence.md) — how *all* instruction surfaces
  (global, AGENTS.md/CLAUDE.md, SKILL.md, MEMORY.md, system prompt) compose, conflict, and **rank**. The governance
  layer.
- [`008-instruction-adherence-decay.md`](topics/RT008-instruction-adherence-decay.md) — *why* the agent keeps regressing to
...
- [`012-inference-time-learning.md`](topics/RT012-inference-time-learning.md) — the frozen pre-training/inference boundary means
...
- [`033-learning-barrier-rqs.md`](topics/RT033-learning-barrier-rqs.md) — the keeper RQs + the **containment thesis**: will the
...
- [`013-confirmation-guard-static-analysis.md`](topics/RT013-confirmation-guard-static-analysis.md) — a model of *when and why* the
...
- [`016-harness-guard-probe-and-custom-guard.md`](topics/RT016-harness-guard-probe-and-custom-guard.md) — jointly introspect *why/how*
...
- [`021-guardcheck-hook-proposal.md`](topics/RT021-guardcheck-hook-proposal.md) — *(DRAFT, needs BR approval)* a **PreToolUse hook**
...
- [`018-recommended-plugin-settings.md`](topics/RT018-recommended-plugin-settings.md) — which `settings.local.json` rules to *ship*
  with the plugin: minimal confirmation friction **without** widening the attack surface. A safe-by-design
  deliverable, not an afterthought.
- [`005-instrumentation-by-default.md`](topics/RT005-instrumentation-by-default.md) — should scratch/CLI tools emit their own
...
- [`010-task-autonomy-negotiation.md`](topics/RT010-task-autonomy-negotiation.md) — per task, where does it sit between a hand-over
  **ralph-loop** and an active **ballgame**? Verifiability is the deciding signal; agent proposes the mode, human
  confirms.
- [`011-human-state-and-joint-zone.md`](topics/RT011-human-state-and-joint-zone.md) — model the *human's* smart/dumb zone too, and
...
- [`024-agent-affective-analogs.md`](topics/RT024-agent-affective-analogs.md) — the mirror of the human-state note: do human
...
- [`009-shared-file-editing-protocol.md`](topics/RT009-shared-file-editing-protocol.md) — when human and agent edit the same file
...
- [`019-subagent-genscalator-propagation.md`](topics/RT019-subagent-genscalator-propagation.md) — does a spawned sub-agent inherit
  genscalator's `tt` tools, skills, methodology, and allowlist — so delegated work stays safe-by-design? If not, how
  to make it so.
- [`034-defining-an-agent-task-state-model.md`](topics/RT034-defining-an-agent-task-state-model.md) — *(stub)* the states an ongoing
...
- [`028-agent-psyche-literature-review.md`](topics/RT028-agent-psyche-literature-review.md) — *(proposed)* a grounding lit review of
...
- [`029-cross-model-psyche-comparison.md`](topics/RT029-cross-model-psyche-comparison.md) — empirically comparing frontier-model
...
- [`020-model-capability-and-leverage.md`](topics/RT020-model-capability-and-leverage.md) — how a more-capable base model leverages
...
- [`040-dry-vs-dependency-surface.md`](topics/RT040-dry-vs-dependency-surface.md) — when is DRY right vs when is repetition
...
- [`038-tt-shared-helper-file-pattern.md`](topics/RT038-tt-shared-helper-file-pattern.md) — the reuse pattern behind
...
- [`037-svg-sequence-diagram-tool.md`](topics/RT037-svg-sequence-diagram-tool.md) — the `tt svg` / `tt ascii` sequence-diagram
...
- [`045-seq-dsl-mermaid-vs-graphviz.md`](topics/RT045-seq-dsl-mermaid-vs-graphviz.md) — *(open)* should the bespoke sequence DSL
...
- [`046-reqt-lang-md-diagram-sources.md`](topics/RT046-reqt-lang-md-diagram-sources.md) — *(open)* store diagram sources as
...
- [`015-reqt-lang-review.md`](topics/RT015-reqt-lang-review.md) — using reqT-lang for genscalator's own PRD dogfoods the
...
- [`014-tt-typed-args.md`](topics/RT014-tt-typed-args.md) — should `tt` tools adopt Scala `@main` typed params, roll their own typed
  arg layer, or mix? Typed args at the tool boundary = smarter+safer applied to the CLI itself.
- [`031-references-summary-enum-design.md`](topics/RT031-references-summary-enum-design.md) — design-validation of the `Summary` enum
...
- [`036-references-refactor-plan.md`](topics/RT036-references-refactor-plan.md) — *(pinned TODO)* split `References.scala`'s rendering
  logic from its data (`mkMarkdown(r)` etc., likely a separate render module / an SSG resource); parked-but-pinned.
- [`026-kyo-ai-inspiration.md`](topics/RT026-kyo-ai-inspiration.md) — *(to investigate)* what genscalator can mine from **kyo-ai**
  (Scala 3 algebraic-effects LLM/agent module) — typed effects for agent workflows.
- [`025-experiment-prioritization.md`](topics/RT025-experiment-prioritization.md) — the rule for *what experiment to run next*: the
  one most likely to build valuable **new** knowledge relative to the planet's research front (marginal frontier
  value).
- [`035-go-verb-vocabulary.md`](topics/RT035-go-verb-vocabulary.md) — *(proposal)* a small, **hardened** set of `go X` verbs
...
### Cases and roadmap
- [`030-ssg-scoping.md`](topics/RT030-ssg-scoping.md) — scoping the static-site generator to publish the blog to bjornregnell.se;
  agent-scouted, leaning **Laika**, with a spike as the next step. Input to the SSG WR case study.
- [`023-course-driven-development.md`](topics/RT023-course-driven-development.md) — *(idea)* run BR's MSc RE course as three student
