...
- **Status:** new (2026-07-03). Seeded *in conversation* by BR spotting that the agent's **"over-response bias"**
  ...
  [`011-human-state-and-joint-zone.md`](RT011-human-state-and-joint-zone.md): that note asks *can the agent model the human's
...
- Nothing yet — research note. **Graduation candidates:** a preregistered framing-intensity run (§5) alongside the
  ...
  `controlAgentSystem` mirror. Pairs with [`011-human-state-and-joint-zone.md`](RT011-human-state-and-joint-zone.md) (the
