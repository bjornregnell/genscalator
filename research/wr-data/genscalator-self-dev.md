...
**adherence-decay / trained-reflex** failure mode ([`../008-instruction-adherence-decay.md`](../topics/RT008-instruction-adherence-decay.md)):
...
cwd-walk-first is the general fix.) Cross-ref [`../019-subagent-genscalator-propagation.md`](../topics/RT019-subagent-genscalator-propagation.md)
