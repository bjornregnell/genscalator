...
*As of 2026-07-21 19:13 (commit-stamped by this file's own git log):*
...
* README/HUMANS lean-deep split done: BR cut the README (`1e70c5e`), HUMANS.md built out with
  ...
  issues section that issue-000 promises.
...
* Session-boundary prep: first warp/compact under the SM192 lean-ember design.
